...
class FieldConfigurator {
    ...
    /**
     * Applies default values to a field that may have been previously configured
     * @param config
     */
    defaults(config) {
        this.fields[this.field] = _.assign({}, config, this.fields[this.field]);
    }

    /**
     * Sets driver-specific field metadata that can be used by result consumers
     * @param metadata
     */
    metadata(metadata) {
