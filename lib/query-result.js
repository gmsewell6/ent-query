...
class QueryResult {
    ...
    shim () {
        ...
        return {
            ...
            fields: function (value) {
                ...
                self.fields = _.defaults({}, self.fields, value);
                return this;
            },
     ...
     */
    toArray () {
        return new P((resolve, reject) => this.stream().on('error', reject).toArray(resolve));
    }

    /**
     * Cancels the result by ending the stream.
     * The source stream is destroyed, the internal passthrough pushes null to end downstream and is then unpiped
     * @returns {QueryResult}
     */
    cancel () {
        this._source.destroy();
        this._passthrough.push(null);
        this._passthrough.unpipe();
        return this;
    }
}
