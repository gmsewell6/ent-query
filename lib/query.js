...
QueryResult.prototype.field = function(field, callback) {
    var self = this;

    var fieldConfig = {
        typeMapping: function (type) {
            self.fields[field] = _.assign({}, self.fields[field], { typeMapping: type });
            return this;
        },
        type: function (type) {
            self.fields[field] = _.assign({}, self.fields[field], { typeMapping: { type: type } });
            return this;
        },
        label: function (label) {
            self.fields[field] = _.assign({}, self.fields[field], { label: label });
            return this;
        },
        position: function(position) {
            self.fields[field] = _.assign({}, self.fields[field], { position: position });
            return this;
        }
    };
